...
const Cart = ()=>{
    _s();
    const cartItem = (0, _reactRedux.useSelector)((store)=>{
        // console.log(store);
    ...
    if (cartItem.length == 0) return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        className: "w-6/12 m-auto p-4 bg-green-500 rounded-lg mt-8",
        children: [
...
},{"react/jsx-dev-runtime":"iTorj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru","react-redux":"62sf7","../utils/constants":"hB8jg","../utils/cartSlice":"5RXlr","./ItemList":"kZjho"}]},["lTJaZ","1xC6H"], null, "parcelRequire164e")
